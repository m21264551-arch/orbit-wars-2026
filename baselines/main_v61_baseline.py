...
SEARCH_MAX_PER_SOURCE_4P = int("3")
SEARCH_MAX_ACTIONS_TO_EVAL_4P = int("12")
SEARCH_MAX_ACTIONS_TO_PICK = 5
SEARCH_MAX_ACTIONS_TO_PICK_4P = int("5")
SEARCH_MAX_ACTIONS_TO_PICK_2P = 9
SEARCH_DISABLES_CHEAP_PICKUP = "1" != "0"
HAMMER_MELIS_VERIFY = True
SEARCH_DEPTH2_ENABLED = True
SEARCH_DEPTH2_4P_ENABLED = "0" != "0"
SEARCH_ORDER_4P_ENABLED = "0" != "0"
...
SO1_STATIC_BONUS_2P = float("2.179862")
...
VALUE_WEIGHT_2P = float("4.86118")
VALUE_WEIGHT_4P = float("2.0")


FOUR_P_PAYLOAD_PRESSURE_ENABLED = "0" != "0"
FOUR_P_COMPOUND_ENABLED = "0" != "0"
FOUR_P_PRESSURE_START = int("18")
FOUR_P_PRESSURE_END = int("125")
FOUR_P_PRESSURE_MIN_AVAIL = int("18")
FOUR_P_PRESSURE_MIN_PROD = int("3")
FOUR_P_PRESSURE_MAX_TRAVEL = int("28")
FOUR_P_PRESSURE_MAX_PER_TURN = int("4")
FOUR_P_PRESSURE_RATIO_PROD2 = float("0.45")
FOUR_P_PRESSURE_RATIO_PROD3 = float("0.55")
FOUR_P_PRESSURE_RATIO_PROD4 = float("0.65")
FOUR_P_PRESSURE_RATIO_ENEMY = float("0.70")
...
SUBSYSTEM_INSTRUMENT_ENABLED = "0" != "0"
SUBSYSTEM_INSTRUMENT_FILE = "v64_instr.jsonl"
_instr_counts = None
_instr_actions = 0
_instr_ships = 0
_instr_game_id = 0
...
NEUTRAL_TEMPO_FILTER_ENABLED = "1" != "0"
...
HAMMER_ENABLED = True
HAMMER_STOCKPILE_MIN = int("50")
HAMMER_TARGET_PROD_MIN = 2
HAMMER_PROD_SHARE_TRIGGER = float("0.40")
HAMMER_OVERKILL_RATIO = float("1.30")
...
BRAIN_LEAD_RESERVE_MIN_SHIPS = int("200")
...
MODE_PARAMS_2P = {
    ...
    "pressure": {
        "expand_k_opening": int("5"),
        "expand_max_travel_opening": 35,
        "expand_k_mid": int("2"),
        "expand_max_travel_mid": 52,
        "hammer_prod_share": float("0.25"),
        "hammer_overkill": float("1.177645"),
        "hammer_stockpile_min": int("25"),
    },
}
